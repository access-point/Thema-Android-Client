...
public class CreatorColorsRecyclerAdapter extends RecyclerView.Adapter<CreatorColorsRecyclerAdapter.MyViewHolder> {
    ...
    public CreatorColorsRecyclerAdapter(Fabric fabric, Activity activity) {
        this.fabric = fabric;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_creator_color_recycler, parent, false);
